    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkedInAccounts", x => x.LinkedInAccountId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReminderContacts", x => new { x.ReminderId, x.UserId, x.ContactId });
                    table.ForeignKey(
                        name: "FK_ReminderContacts_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "ContactId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReminderContacts_Reminders_ReminderId",
                        column: x => x.ReminderId,
                        principalTable: "Reminders",
                        principalColumn: "ReminderId");
                    table.ForeignKey(
                        name: "FK_ReminderContacts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReminderContacts_ContactId",
                table: "ReminderContacts",
                column: "ContactId");

            migrationBuilder.CreateIndex(
                name: "IX_ReminderContacts_UserId",
                table: "ReminderContacts",
                column: "UserId");
